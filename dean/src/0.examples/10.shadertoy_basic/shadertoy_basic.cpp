...
int main()
{
    ...
    vector<Shader> shaders = {
        // key 0, https://inspirnathan.com/posts/51-shadertoy-tutorial-part-5
        Shader("shared.vs", "basic_2d.fs"),
        // key 1, https://www.youtube.com/watch?v=dKA5ZVALOhs
        Shader("shared.vs", "simplest_3d.fs"),
        // key 2, https://www.youtube.com/watch?v=PGtv-dBi2wE
        Shader("shared.vs", "basic_ray_marching.fs"),
    };
